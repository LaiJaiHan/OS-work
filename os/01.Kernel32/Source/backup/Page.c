...
void kInitializePageTables( void )
{
	...
	PDENTRY* pstPDEntry;
    PML4TENTRY* pstPML4TEntry4;
    PDPTENTRY* pstPDPTEntry4;
    PDENTRY* pstPDEntry4;
    PTENTRY* pstPTEntry4;
    ...
    //Page Table Entry
    pstPTEntry4 = (PTENTRY*) 0x103000;
    dwMappingAddress = 0;

    for(i=0; i <PAGE_MAXENTRYCOUNT; i++)
    {
        kSetPageEntryData( &(pstPTEntry4[i]),
				( i * (PAGE_DEFAULTSIZE>>20)) >>12 , dwMappingAddress, 
				PAGE_FLAGS_DEFAULT2 | PAGE_FLAGS_4KB, 0 );
    }
